...
(function(definition) {
  ...
  */
  ...
  function api_url(name) {
    let _url = "https://" + name;
    if (_url.indexOf('freshbooks.com') > -1 || _url.indexOf('billingarm.com') > -1) {
      return _url + "/api/2.1/xml-in";
    } else {
      console.log('Error: please use a proper freshbooks.com/billingarm.com secondary domain in your configuration.')
      return null;
    }
  }
